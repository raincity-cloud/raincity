...
export const abacStatusSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(BucketAbacStatus).optional(),
});
...
export const abortMultipartUploadOutputSchema = z.object({ RequestCharged: z.enum(RequestCharged).optional() });
...
export const abortMultipartUploadRequestSchema = z.object({
   ...
   */
  UploadId: z.string(),
  RequestPayer: z.enum(RequestPayer).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  IfMatchInitiatedTime: imfFixdateTimestampSchema.optional(),
});
...
export const accelerateConfigurationSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(BucketAccelerateStatus).optional(),
});
...
export const accessControlPolicySchema = z.object({
   ...
   * ```
   */
  Grants: z.array(z.lazy(() => grantSchema)).optional(),
  /**
   * ```xml
...
export const analyticsConfigurationSchema = z.object({
   ...
   * ```
   */
  Filter: z.union([z.string(), z.lazy(() => tagSchema), z.lazy(() => analyticsAndOperatorSchema)]).optional(),
  /**
   * ```xml
...
export const analyticsS3BucketDestinationSchema = z.object({
   ...
   * ```
   */
  Format: z.enum(AnalyticsS3ExportFileFormat),
  /**
   * ```xml
...
export const blockedEncryptionTypesSchema = z.object({
   ...
   * ```
   */
  EncryptionType: z.array(z.enum(EncryptionType)).optional(),
});
...
export const bucketSchema = z.object({
   ...
   * ```
   */
  CreationDate: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
   * <p>
...
export const bucketInfoSchema = z.object({
   ...
   * ```
   */
  DataRedundancy: z.enum(DataRedundancy).optional(),
  /**
   * ```xml
   * <p>The type of bucket.</p>
   * ```
   */
  Type: z.enum(BucketType).optional(),
});
...
export const bucketLifecycleConfigurationSchema = z.object({
   ...
   * ```
   */
  Rules: z.array(z.lazy(() => lifecycleRuleSchema)),
});
...
export const corsConfigurationSchema = z.object({
   ...
   * ```
   */
  CORSRules: z.array(z.lazy(() => corsRuleSchema)),
});
...
export const csvInputSchema = z.object({
   ...
   * ```
   */
  FileHeaderInfo: z.enum(FileHeaderInfo).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  QuoteEscapeCharacter: z.string().optional(),
  /**
   * ```xml
   ...
   * ```
   */
  RecordDelimiter: z.string().optional(),
  /**
   * ```xml
   ...
   * ```
   */
  AllowQuotedRecordDelimiter: z.boolean().optional(),
});
...
export const csvOutputSchema = z.object({
   ...
   * ```
   */
  QuoteFields: z.enum(QuoteFields).optional(),
  /**
   * ```xml
...
export const checksumSchema = z.object({
   ...
   * ```
   */
  ChecksumType: z.enum(ChecksumType).optional(),
});
...
export const completeMultipartUploadOutputSchema = z.object({
   ...
   * ```
   */
  ServerSideEncryption: z.enum(ServerSideEncryption).optional(),
  /**
   * ```xml
  ...
  RequestCharged: z.enum(RequestCharged).optional(),
});
...
export const completeMultipartUploadRequestSchema = z.object({
   ...
   * ```
   */
  MpuObjectSize: z.bigint().optional(),
  RequestPayer: z.enum(RequestPayer).optional(),
  /**
   * ```xml
   * <p>The account ID of the expected bucket owner. If the account ID that you provide does not match the actual owner of the bucket, the request fails with the HTTP status code <code>403 Forbidden</code> (access denied).</p>
...
export const completedMultipartUploadSchema = z.object({
   ...
   * ```
   */
  Parts: z.array(z.lazy(() => completedPartSchema)).optional(),
});
...
export const copyObjectRequestSchema = z.object({
   ...
   * ```
   */
  ACL: z.enum(ObjectCannedAcl).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  ChecksumAlgorithm: z.enum(ChecksumAlgorithm).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  CopySource: z.string().regex(new RegExp("^\\/?.+\\/.+$")),
  /**
   * ```xml
   ...
   * ```
   */
  CopySourceIfModifiedSince: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
   ...
   * ```
   */
  CopySourceIfUnmodifiedSince: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
   ...
   * ```
   */
  MetadataDirective: z.enum(MetadataDirective).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  TaggingDirective: z.enum(TaggingDirective).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  CopySourceSSECustomerAlgorithm: z.string().optional(),
  /**
   * ```xml
   ...
   * ```
   */
  CopySourceSSECustomerKey: z.string().optional(),
  /**
   * ```xml
   * <p>Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header
   *       for a message integrity check to ensure that the encryption key was transmitted without error.</p>
   ...
   * ```
   */
  CopySourceSSECustomerKeyMD5: z.string().optional(),
  RequestPayer: z.enum(RequestPayer).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  ObjectLockMode: z.enum(ObjectLockMode).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  ObjectLockRetainUntilDate: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
   ...
   * ```
   */
  ObjectLockLegalHoldStatus: z.enum(ObjectLockLegalHoldStatus).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  ExpectedSourceBucketOwner: z.string().optional(),
});
...
export const copyObjectResultSchema = z.object({
   ...
   * ```
   */
  LastModified: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
   * <p>The checksum type that is used to calculate the object’s checksum value. For more information, see
   *         <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
...
export const createBucketConfigurationSchema = z.object({
   ...
   * ```
   */
  LocationConstraint: z.enum(BucketLocationConstraint).optional(),
  /**
   * ```xml
...
export const createBucketRequestSchema = z.object({
   ...
   * ```
   */
  ACL: z.enum(BucketCannedAcl).optional(),
  /**
   * ```xml
  ...
  ObjectOwnership: z.enum(ObjectOwnership).optional(),
});
...
export const createMultipartUploadOutputSchema = z.object({
   ...
   * ```
   */
  AbortDate: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
...
export const createSessionRequestSchema = z.object({
   ...
   * ```
   */
  SessionMode: z.enum(SessionMode).optional(),
  /**
   * ```xml
...
export const defaultRetentionSchema = z.object({
   ...
   * ```
   */
  Mode: z.enum(ObjectLockRetentionMode).optional(),
  /**
   * ```xml
...
export const deleteSchema = z.object({
   ...
   * ```
   */
  Objects: z.array(z.lazy(() => objectIdentifierSchema)),
  /**
   * ```xml
...
export const deleteMarkerReplicationSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(DeleteMarkerReplicationStatus).optional(),
});
...
export const deleteObjectRequestSchema = z.object({
   ...
   * ```
   */
  IfMatchLastModifiedTime: imfFixdateTimestampSchema.optional(),
  /**
   * ```xml
...
export const deleteObjectsOutputSchema = z.object({
   ...
   * ```
   */
  Deleted: z.array(z.lazy(() => deletedObjectSchema)).optional(),
  RequestCharged: z.enum(RequestCharged).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  Errors: z.array(z.lazy(() => errorSchema)).optional(),
});
...
export const destinationResultSchema = z.object({
   ...
   * ```
   */
  TableBucketType: z.enum(S3TablesBucketType).optional(),
  /**
   * ```xml
   * <p>
   ...
   * ```
   */
  TableNamespace: z.string().optional(),
});
...
export const encryptionSchema = z.object({
   ...
   * ```
   */
  EncryptionType: z.enum(ServerSideEncryption),
  /**
   * ```xml
...
export const existingObjectReplicationSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(ExistingObjectReplicationStatus),
});
...
export const filterRuleSchema = z.object({
   ...
   * ```
   */
  Name: z.enum(FilterRuleName).optional(),
  /**
   * ```xml
...
export const getBucketCorsOutputSchema = z.object({
   ...
   * ```
   */
  CORSRules: z.array(z.lazy(() => corsRuleSchema)).optional(),
});
...
export const getBucketLifecycleConfigurationOutputSchema = z.object({
   ...
   * ```
   */
  Rules: z.array(z.lazy(() => lifecycleRuleSchema)).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  TransitionDefaultMinimumObjectSize: z.enum(TransitionDefaultMinimumObjectSize).optional(),
});
...
export const getBucketTaggingOutputSchema = z.object({
   ...
   * ```
   */
  TagSet: z.array(z.lazy(() => tagSchema)),
});
...
export const getBucketVersioningOutputSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(BucketVersioningStatus).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  MFADelete: z.enum(MfaDeleteStatus).optional(),
});
...
export const getBucketWebsiteOutputSchema = z.object({
   ...
   * ```
   */
  RoutingRules: z.array(z.lazy(() => routingRuleSchema)).optional(),
});
...
export const getObjectAttributesPartsSchema = z.object({
   ...
   * ```
   */
  TotalPartsCount: z.number().optional(),
  /**
   * ```xml
   * <p>The marker for the current part.</p>
   * ```
   */
  PartNumberMarker: z.string().optional(),
  /**
   * ```xml
   ...
   * ```
   */
  NextPartNumberMarker: z.string().optional(),
  /**
   * ```xml
   ...
   * ```
   */
  Parts: z.array(z.lazy(() => objectPartSchema)).optional(),
});
...
export const getObjectAttributesRequestSchema = z.object({
   ...
   * ```
   */
  ObjectAttributes: z.array(z.enum(ObjectAttributes)),
});
...
export const getObjectOutputSchema = z.object({
   ...
   * ```
   */
  ContentLength: z.bigint().optional(),
  /**
   * ```xml
   ...
   * ```
   */
  ReplicationStatus: z.enum(ReplicationStatus).optional(),
  /**
   * ```xml
...
export const getObjectRequestSchema = z.object({
   ...
   * ```
   */
  IfModifiedSince: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
   ...
   * ```
   */
  IfUnmodifiedSince: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
   ...
   * ```
   */
  ResponseExpires: imfFixdateTimestampSchema.optional(),
  /**
   * ```xml
   * <p>Version ID used to reference a specific version of the object.</p>
   ...
   * ```
   */
  ChecksumMode: z.enum(ChecksumMode).optional(),
});
...
export const headBucketOutputSchema = z.object({
   ...
   * ```
   */
  BucketLocationType: z.enum(LocationType).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  BucketLocationName: z.string().optional(),
  /**
   * ```xml
   * <p>The Region that the bucket is located.</p>
   * ```
   */
  BucketRegion: z.string().min(0).max(20).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  AccessPointAlias: z.boolean().optional(),
});
...
export const headObjectOutputSchema = z.object({
   ...
   * ```
   */
  ArchiveStatus: z.enum(ArchiveStatus).optional(),
  /**
   * ```xml
   * <p>Date and time when the object was last modified.</p>
   * ```
...
export const inputSerializationSchema = z.object({
   ...
   * ```
   */
  CompressionType: z.enum(CompressionType).optional(),
  /**
   * ```xml
...
export const inventoryConfigurationSchema = z.object({
   ...
   * ```
   */
  IncludedObjectVersions: z.enum(InventoryIncludedObjectVersions),
  /**
   * ```xml
   * <p>Contains the optional fields that are included in the inventory results.</p>
   * ```
   */
  OptionalFields: z.array(z.enum(InventoryOptionalField)).optional(),
  /**
   * ```xml
...
export const inventoryScheduleSchema = z.object({
   ...
   * ```
   */
  Frequency: z.enum(InventoryFrequency),
});
...
export const inventoryTableConfigurationSchema = z.object({
   ...
   * ```
   */
  ConfigurationState: z.enum(InventoryConfigurationState),
  /**
   * ```xml
   * <p>
...
export const lifecycleExpirationSchema = z.object({
   ...
   * ```
   */
  Date: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
...
export const lifecycleRuleSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(ExpirationStatus),
  /**
   * ```xml
   ...
   * ```
   */
  NoncurrentVersionTransitions: z.array(z.lazy(() => noncurrentVersionTransitionSchema)).optional(),
...
export const lifecycleRuleAndOperatorSchema = z.object({
   ...
   * ```
   */
  ObjectSizeGreaterThan: z.bigint().optional(),
  /**
   * ```xml
   * <p>Maximum object size to which the rule applies.</p>
   * ```
   */
  ObjectSizeLessThan: z.bigint().optional(),
});
...
export const listBucketAnalyticsConfigurationsOutputSchema = z.object({
   ...
   * ```
   */
  AnalyticsConfigurationList: z.array(z.lazy(() => analyticsConfigurationSchema)).optional(),
});
...
export const listBucketIntelligentTieringConfigurationsOutputSchema = z.object({
   ...
   * ```
   */
  IntelligentTieringConfigurationList: z.array(z.lazy(() => intelligentTieringConfigurationSchema)).optional(),
});
...
export const listBucketInventoryConfigurationsOutputSchema = z.object({
   ...
   * ```
   */
  InventoryConfigurationList: z.array(z.lazy(() => inventoryConfigurationSchema)).optional(),
  /**
   * ```xml
...
export const listBucketMetricsConfigurationsOutputSchema = z.object({
   ...
   * ```
   */
  MetricsConfigurationList: z.array(z.lazy(() => metricsConfigurationSchema)).optional(),
});
...
export const listBucketsRequestSchema = z.object({
   ...
   * ```
   */
  MaxBuckets: z.number().min(1).max(10000).optional(),
  /**
   * ```xml
   * <p>
...
export const listDirectoryBucketsOutputSchema = z.object({
   ...
   * ```
   */
  ContinuationToken: z.string().min(0).max(1024).optional(),
});
...
export const listDirectoryBucketsRequestSchema = z.object({
   ...
   * ```
   */
  MaxDirectoryBuckets: z.number().min(0).max(1000).optional(),
});
...
export const listMultipartUploadsOutputSchema = z.object({
   ...
   * ```
   */
  Uploads: z.array(z.lazy(() => multipartUploadSchema)).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  CommonPrefixes: z.array(z.lazy(() => commonPrefixSchema)).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  EncodingType: z.enum(EncodingType).optional(),
  RequestCharged: z.enum(RequestCharged).optional(),
});
...
export const listObjectVersionsOutputSchema = z.object({
   ...
   * ```
   */
  Versions: z.array(z.lazy(() => objectVersionSchema)).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  DeleteMarkers: z.array(z.lazy(() => deleteMarkerEntrySchema)).optional(),
  /**
   * ```xml
   * <p>The bucket name.</p>
   * ```
...
export const listObjectVersionsRequestSchema = z.object({
   ...
   * ```
   */
  OptionalObjectAttributes: z.array(z.enum(OptionalObjectAttributes)).optional(),
});
...
export const listObjectsOutputSchema = z.object({
   ...
   * ```
   */
  Contents: z.array(z.lazy(() => objectSchema)).optional(),
  /**
   * ```xml
   * <p>The bucket name.</p>
   * ```
...
export const loggingEnabledSchema = z.object({
   ...
   * ```
   */
  TargetGrants: z.array(z.lazy(() => targetGrantSchema)).optional(),
  /**
   * ```xml
...
export const metadataTableEncryptionConfigurationSchema = z.object({
   ...
   * ```
   */
  SseAlgorithm: z.enum(TableSseAlgorithm),
  /**
   * ```xml
   * <p>
...
export const metricsConfigurationSchema = z.object({
   ...
   * ```
   */
  Filter: z.union([z.string(), z.lazy(() => tagSchema), z.string(), z.lazy(() => metricsAndOperatorSchema)]).optional(),
});
...
export const multipartUploadSchema = z.object({
   ...
   * ```
   */
  Initiated: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
...
export const noncurrentVersionTransitionSchema = z.object({
   ...
   * ```
   */
  StorageClass: z.enum(TransitionStorageClass).optional(),
  /**
   * ```xml
...
export const notificationConfigurationSchema = z.object({
   ...
   * ```
   */
  TopicConfigurations: z.array(z.lazy(() => topicConfigurationSchema)).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  QueueConfigurations: z.array(z.lazy(() => queueConfigurationSchema)).optional(),
  /**
   * ```xml
   * <p>Describes the Lambda functions to invoke and the events for which to invoke them.</p>
   * ```
   */
  LambdaFunctionConfigurations: z.array(z.lazy(() => lambdaFunctionConfigurationSchema)).optional(),
  /**
   * ```xml
...
export const objectSchema = z.object({
   ...
   * ```
   */
  ChecksumAlgorithm: z.array(z.enum(ChecksumAlgorithm)).optional(),
  /**
   * ```xml
   * <p>The checksum type that is used to calculate the object’s checksum value. For more information, see
   *         <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/checking-object-integrity.html">Checking
   ...
   * ```
   */
  StorageClass: z.enum(ObjectStorageClass).optional(),
  /**
   * ```xml
...
export const objectIdentifierSchema = z.object({
   ...
   * ```
   */
  LastModifiedTime: imfFixdateTimestampSchema.optional(),
  /**
   * ```xml
...
export const objectLockConfigurationSchema = z.object({
   ...
   * ```
   */
  ObjectLockEnabled: z.enum(ObjectLockEnabled).optional(),
  /**
   * ```xml
...
export const objectLockLegalHoldSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(ObjectLockLegalHoldStatus).optional(),
});
...
export const objectLockRetentionSchema = z.object({
   ...
   * ```
   */
  RetainUntilDate: rfc3339DateTimeTimestampSchema.optional(),
});
...
export const objectVersionSchema = z.object({
   ...
   * ```
   */
  StorageClass: z.enum(ObjectVersionStorageClass).optional(),
  /**
   * ```xml
   * <p>The object key.</p>
   * ```
...
export const ownershipControlsSchema = z.object({
   ...
   * ```
   */
  Rules: z.array(z.lazy(() => ownershipControlsRuleSchema)),
});
 ...
 * ```
 */
export const ownershipControlsRuleSchema = z.object({ ObjectOwnership: z.enum(ObjectOwnership) });
...
export const partitionedPrefixSchema = z.object({
   ...
   * ```
   */
  PartitionDateSource: z.enum(PartitionDateSource).optional(),
});
...
export const progressSchema = z.object({
   ...
   * ```
   */
  BytesScanned: z.bigint().optional(),
  /**
   * ```xml
   * <p>The current number of uncompressed object bytes processed.</p>
   * ```
   */
  BytesProcessed: z.bigint().optional(),
  /**
   * ```xml
   * <p>The current number of bytes of records payload data returned.</p>
   * ```
   */
  BytesReturned: z.bigint().optional(),
});
...
export const publicAccessBlockConfigurationSchema = z.object({
   ...
   * ```
   */
  BlockPublicAcls: z.boolean().optional(),
  /**
   * ```xml
   ...
   * ```
   */
  IgnorePublicAcls: z.boolean().optional(),
  /**
   * ```xml
   ...
   * ```
   */
  RestrictPublicBuckets: z.boolean().optional(),
});
...
export const putBucketNotificationConfigurationRequestSchema = z.object({
   ...
   * ```
   */
  SkipDestinationValidation: z.boolean().optional(),
});
...
export const putObjectAclOutputSchema = z.object({ RequestCharged: z.enum(RequestCharged).optional() });
...
export const putObjectLegalHoldOutputSchema = z.object({ RequestCharged: z.enum(RequestCharged).optional() });
...
export const putObjectLockConfigurationOutputSchema = z.object({ RequestCharged: z.enum(RequestCharged).optional() });
...
export const putObjectRequestSchema = z.object({
   ...
   * ```
   */
  WriteOffsetBytes: z.bigint().optional(),
  /**
   * ```xml
   * <p>A map of metadata to store with the object in S3.</p>
   * ```
...
export const putObjectRetentionOutputSchema = z.object({ RequestCharged: z.enum(RequestCharged).optional() });
...
export const recordExpirationSchema = z.object({
   ...
   * ```
   */
  Expiration: z.enum(ExpirationState),
  /**
   * ```xml
   * <p>
...
export const redirectSchema = z.object({
   ...
   * ```
   */
  Protocol: z.enum(Protocol).optional(),
  /**
   * ```xml
...
export const renameObjectRequestSchema = z.object({
   ...
   * ```
   */
  RenameSource: z.string().regex(new RegExp("^\\/?.+\\/.+$")),
  /**
   * ```xml
   ...
   * ```
   */
  DestinationIfModifiedSince: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
   * <p>Renames the object if it hasn't been modified since the specified time.</p>
   * ```
   */
  DestinationIfUnmodifiedSince: rfc3339DateTimeTimestampSchema.optional(),
  /**
   * ```xml
   ...
   * ```
   */
  SourceIfModifiedSince: imfFixdateTimestampSchema.optional(),
  /**
   * ```xml
   * <p>Renames the object if the source exists and hasn't been modified since the specified time.</p>
   * ```
   */
  SourceIfUnmodifiedSince: imfFixdateTimestampSchema.optional(),
  /**
   * ```xml
...
export const replicaModificationsSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(ReplicaModificationsStatus),
});
...
export const replicationConfigurationSchema = z.object({
   ...
   * ```
   */
  Rules: z.array(z.lazy(() => replicationRuleSchema)),
});
...
export const replicationRuleSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(ReplicationRuleStatus),
  /**
   * ```xml
...
export const replicationTimeSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(ReplicationTimeStatus),
  /**
   * ```xml
...
export const restoreObjectOutputSchema = z.object({
   ...
   * ```
   */
  RestoreOutputPath: z.string().optional(),
});
...
export const restoreRequestSchema = z.object({
   ...
   * ```
   */
  Type: z.enum(RestoreRequestType).optional(),
  /**
   * ```xml
   * <p>Retrieval tier at which the restore will be processed.</p>
   * ```
...
export const restoreStatusSchema = z.object({
   ...
   * ```
   */
  IsRestoreInProgress: z.boolean().optional(),
  /**
   * ```xml
   ...
   * ```
   */
  RestoreExpiryDate: rfc3339DateTimeTimestampSchema.optional(),
});
 ...
 * ```
 */
export const s3KeyFilterSchema = z.object({ FilterRules: z.array(z.lazy(() => filterRuleSchema)).optional() });
...
export const s3LocationSchema = z.object({
   ...
   * ```
   */
  CannedACL: z.enum(ObjectCannedAcl).optional(),
  /**
   * ```xml
   * <p>A list of grants that control access to the staged results.</p>
   * ```
   */
  AccessControlList: z.array(z.lazy(() => grantSchema)).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  UserMetadata: z.array(z.lazy(() => metadataEntrySchema)).optional(),
  /**
   * ```xml
...
export const selectObjectContentOutputSchema = z.object({
   ...
   */
  Payload: z.union([
    z.lazy(() => recordsEventSchema),
    z.lazy(() => statsEventSchema),
    z.lazy(() => progressEventSchema),
    z.lazy(() => continuationEventSchema),
    z.lazy(() => endEventSchema),
  ]).optional(),
});
...
export const selectObjectContentRequestSchema = z.object({
   ...
   * ```
   */
  ExpressionType: z.enum(ExpressionType),
  /**
   * ```xml
...
export const serverSideEncryptionByDefaultSchema = z.object({
   ...
   * ```
   */
  SSEAlgorithm: z.enum(ServerSideEncryption),
  /**
   * ```xml
...
export const serverSideEncryptionConfigurationSchema = z.object({
   ...
   * ```
   */
  Rules: z.array(z.lazy(() => serverSideEncryptionRuleSchema)),
});
...
export const sessionCredentialsSchema = z.object({
   ...
   * ```
   */
  Expiration: rfc3339DateTimeTimestampSchema,
});
...
export const sseKmsEncryptedObjectsSchema = z.object({
   ...
   * ```
   */
  Status: z.enum(SseKmsEncryptedObjectsStatus),
});
...
export const storageClassAnalysisDataExportSchema = z.object({
   ...
   * ```
   */
  OutputSchemaVersion: z.enum(StorageClassAnalysisSchemaVersion),
  /**
   * ```xml
...
export const targetGrantSchema = z.object({
   ...
   * ```
   */
  Permission: z.enum(BucketLogsPermission).optional(),
});
...
export const updateObjectEncryptionRequestSchema = z.object({
   ...
   * ```
   */
  ObjectEncryption: z.union([z.lazy(() => ssekmsEncryptionSchema)]),
  RequestPayer: z.enum(RequestPayer).optional(),
  /**
   * ```xml
   * <p>
...
export const updateObjectEncryptionResponseSchema = z.object({ RequestCharged: z.enum(RequestCharged).optional() });
...
export const versioningConfigurationSchema = z.object({
   ...
   * ```
   */
  MFADelete: z.enum(MfaDelete).optional(),
  /**
   * ```xml
   * <p>The versioning state of the bucket.</p>
   * ```
