...
import { PartitionEndpointPattern } from "./aws.endpoints.enums.js";
...
export const standardPartitionalEndpointsSchema = z.object({
   ...
   * ```
   */
  endpointPatternType: z.enum(PartitionEndpointPattern),
  /**
   * ```xml
   ...
   * ```
   */
  partitionEndpointSpecialCases: z.record(z.string(), z.array(z.lazy(() => partitionEndpointSpecialCaseSchema)))
    .optional(),
});
...
export const standardRegionalEndpointsSchema = z.object({
   ...
   * ```
   */
  partitionSpecialCases: z.record(z.string(), z.array(z.lazy(() => partitionSpecialCaseSchema))).optional(),
  /**
   * ```xml
   ...
   * ```
   */
  regionSpecialCases: z.record(z.string(), z.array(z.lazy(() => regionSpecialCaseSchema))).optional(),
});
